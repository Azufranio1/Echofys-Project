...
// Exportamos el tipo para que Home.tsx pueda usarlo
  ...
  return (
    <>
      <style>{`
        ...
        .echofy-logo-disc {
          color: #a78bfa; animation: spin 8s linear infinite; position: relative; z-index: 1;
        }
        @keyframes spin { to { transform: rotate(360deg); } }
        .echofy-logo-text {
          font-size: 17px; font-weight: 800; letter-spacing: 0.28em;
        ...
        /* Search */
        .echofy-search-wrap {
          flex: 1; max-width: 420px; margin: 0 28px; position: relative;
        }
        .echofy-search-icon {
        ...
        .echofy-search-input {
          ...
          padding: 0 16px 0 40px; outline: none; transition: all 0.25s;
        }
        ...
        .echofy-logout:hover {
          color: #fca5a5; border-color: rgba(252,165,165,0.35);
          background: rgba(252,165,165,0.07);
        }

        /* ── MAIN ── */
        .echofy-main {
          flex: 1; /* Esto obliga al contenido a crecer y ocupar todo el espacio disponible */
          overflow-y: auto;
          overflow-x: hidden;
          width: 100%; /* CRUCIAL: Fuerza el ancho completo */
          background: 
            radial-gradient(ellipse 70% 50% at 50% -10%, rgba(88,28,220,0.2) 0%, transparent 65%),
            #080810;
        }
        ...
        /* Sin max-width — full screen */
        .echofy-content {
          width: 100%;
          max-width: 1400px; /* Opcional: para que no se vea tan estirado en monitores gigantes */
        ...
        .echofy-player-footer {
          flex: 0 0 90px; position: relative; z-index: 50; background: #05050e;
        }
      ...
      <div className="echofy-layout">
        ...
        {/* CONTENIDO — pasa searchQuery a las páginas hijas */}
