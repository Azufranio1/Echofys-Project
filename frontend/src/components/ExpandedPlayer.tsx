  ...
  return (
    <>
      <style>{`
        ...
        .exp-queue-item.active {
          background: rgba(139,92,246,0.14); border-color: rgba(139,92,246,0.28);
        }
        .exp-queue-thumb {
        ...
        /* ── MINI PLAYER DENTRO DEL EXPANDED ── */
        .exp-player-bar {
          position: relative; z-index: 10;
          flex-shrink: 0;
          display: flex; align-items: center; justify-content: space-between;
        ...
        .exp-bar-thumb-dot {
          ...
          box-shadow: 0 0 6px rgba(139,92,246,0.9); opacity: 0;
        ...
        .exp-bar-right {
          ...
          width: 26%; justify-content: flex-end;
        }
        .exp-bar-icon-btn {
          background: none; border: none; cursor: pointer; color: #4B5563;
        ...
        .exp-vol-bar-wrap {
          position: relative; width: 80px; height: 3px; cursor: pointer; border-radius: 4px;
        }
      ...
      <div className="exp-root">
        ...
        {song.artwork && (
          <div className="exp-bg-art" style={{ backgroundImage: `url(${song.artwork})` }} />
        )}
        ...
        <div className="exp-body">
          ...
          <div className="exp-left">
            ...
            <div className="exp-song-title">{song.title}</div>
            <div className="exp-song-artist">{song.artist}</div>

            {/* Metadata como lista de texto plano */}
            <div className="exp-meta-list">
              {song.album && (
                <div className="exp-meta-row">
                  <span className="exp-meta-key">Álbum</span>
                  <span className="exp-meta-val">{song.album}</span>
                </div>
              )}
              {song.year && (
                <div className="exp-meta-row">
                  <span className="exp-meta-key">Año</span>
                  <span className="exp-meta-val">{song.year}</span>
                </div>
              )}
              {song.genre && (
                <div className="exp-meta-row">
                  <span className="exp-meta-key">Género</span>
                  <span className="exp-meta-val">{song.genre}</span>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="exp-player-bar">
          ...
          <div className="exp-bar-center">
            <div className="exp-bar-controls">
              <button className="exp-bar-btn" onClick={onSkipBack}>
                <SkipBack size={18} fill="currentColor" />
              </button>
              <button
                className={`exp-bar-btn-play ${isPlaying ? 'playing' : ''}`}
                onClick={togglePlay}
              >
                {isPlaying
              ...
              <button className="exp-bar-btn" onClick={onSkipForward}>
            ...
            <div className="exp-bar-progress">
              ...
              <div className="exp-bar-track-wrap">
                <div className="exp-bar-track-bg">
                  <div className="exp-bar-track-fill" style={{ width: `${prog}%` }} />
                </div>
                <div className="exp-bar-thumb-dot" style={{ left: `${prog}%` }} />
                <input
                  type="range"
                  className="exp-bar-range"
                  min={0}
                  max={duration || 0}
                  value={currentTime}
          ...
          <div className="exp-bar-right">
            <button className="exp-bar-icon-btn dl" onClick={onDownload} title="Descargar">
              <Download size={15} />
            </button>
            ...
            <div className="exp-vol-bar-wrap">
              <div className="exp-bar-track-bg">
                <div className="exp-bar-track-fill" style={{ width: `${volDisplay}%` }} />
              </div>
